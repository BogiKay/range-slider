...
class RangeSliderViewManager : ViewGroupManager<RangeSliderView>() {
    override fun getName(): String = RangeSliderView.NAME
    ...
    override fun setInactiveColor(view: RangeSliderView?, value: Int?) {
        view?.setInactiveColor(value)
    }
    ...
    @ReactProp(name = "step")
    override fun setStep(view: RangeSliderView?, value: Int) {
        view?.setStep(value)
    }
